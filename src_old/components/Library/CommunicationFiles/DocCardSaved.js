...
const DocCardSaved = (props) => {
    ...
    return (
        ...
        <Fragment>
            <div className={`overflow-hidden card mb-1 py-1 border-left-info ${styles.docrow}`}>
                <div className="row card-body p-1 align-items-center">
                    ...
                    <div className="row col-lg-9 bg-gray-200 rounded py-1">
                                ...
                                <div className="col-auto">
                                    <div className="h6 mb-0 mr-3 font-weight-bold text-gray-800 ">
                                        ...
                                        {/* <p> <span className='text-secondary'>Date : </span>{FormattedDate(props.item.date)}</p> */}
                                          <p className="text-truncate"> 
                                            <span className='text-secondary'>Type : </span>{props.item.file_type}
                                        </p>
