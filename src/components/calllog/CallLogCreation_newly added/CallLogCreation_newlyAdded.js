...
//  useEffect(()=>{
//   console.log("fileList from Parent", fileList)
//  },[fileList])
...
useEffect(()=>{
  ...
  const handleSubmit = (e) => {
    ...
    let data = {
      ...
      procurement_type_id: input.procurement?.value ? input.procurement?.value: null,
      bizz_forecast_id: input.businessForecast.value,
      bizz_forecast_status_id: input.forecastStatus?.value ? input.forecastStatus?.value :null,
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              ...
              <div className="row align-items-center">
                ...
                />
                <div className="inputgroup col-lg-12 mt-3 mb-4 save_cancel">
                  <button
