...
import ReadyToUploadCP from "./ReadyTouploadCP";
import styles from './UploadDocCP.module.css';
import Swal from "sweetalert2";
import DocListPreBid from "./DocListCP";
...
const CorrigendumPublish = () => {
    ...
    const postData = (data) => {
        ...
        axios.post(`${baseUrl}/api/bidcreation/corrigendumpublish/docupload`, data, config).then((resp) => {
    ...
    const putData = (data, UploadDocId) => {
        axios.post(`${baseUrl}/api/bidcreation/corrigendumpublish/docupload/${UploadDocId}`, data, config).then((resp) => {
            if (resp.data.status === 200) {
              ref.current.getDocList()
              resetform()
              toastSuccess(resp.data.message)
                        ...
                        <div className="inputgroup col-lg-6 mb-4 ">
                            ...
                            {(file !== null) && <div className="row">
                                ...
                                <div className="col-lg-8 text-dark mt-1">
                                    <ReadyToUploadCP file={file} date={DateValue} />
                                </div>
                            </div>}
                        </div>
                        <div className="inputgroup col-lg-6 mb-4">
